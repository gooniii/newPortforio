...
if (isMobile)
    controller.addScene([headerScene, visualScene, visualPinScene, aboutProfileScene, aboutWordScene, workWordScene, prWordScene]),
...
var windowLoadEvt = function () {
        isMobileSize(),
            isMobileSize() ? (prScrollScene.enabled(!1), (prCont.style.transform = 'translateX(0%)')) : prScrollScene.enabled(!0),
